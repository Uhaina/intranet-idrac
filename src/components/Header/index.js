    ...
    return (
      <div className="header-component">
          <div className="header-component-content">
            <NavLink to='/'>
              <img className="logo-idrac" src="http://intranet-idrac.fr/logo_idrac.png"/>
            </NavLink>
            <div className="header-navigation">
              ...
              <NavLink className="header-item" activeClassName="active" to='/carnet-adresse'>Carnet d'adresses</NavLink>
            ...
            <div className="header-out-website">
              <a href="https://outlook.office.com/owa/?realm=idracmontpellier.net" target="_blank" className="header-item-outlook">
                <img src="http://intranet-idrac.fr/outlook.png" className="github-logo"/>
              </a>
            ...
            <div className="menu-mobile" onClick={this.activeBurger}>
              { this.state.menuOpen === true ? (
                <img src="http://intranet-idrac.fr/cross.png" className="github-logo"/>
              ) : (
        ...
        <div className={responsiveClass}>
          ...
          <NavLink className="menu-burger-item" onClick={this.activeBurger} to='/carnet-adresse'>Carnet d'adresses</NavLink>
